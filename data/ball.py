...
import random
from . import tools
'''isso aqui são as bolas tanto fantasma quanto normal é a regra do que vai acontecer quando ela colidir em algo'''
class Ball:
    ...
    def get_random_float(self):
        '''Pega o Float para a velocidade da bola em uma direção'''
        while True:
