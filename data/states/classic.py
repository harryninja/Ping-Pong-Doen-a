...
from .. import AI
import random
'''esse é o codigo do modo classico importando o paddle que é o traço jogador e rival, a inteligencia do rival, a bola, e definições do tools.'''
class Classic(tools.States):
    def __init__(self, screen_rect, difficulty): 
        tools.States.__init__(self)
        self.screen_rect = screen_rect
        self.score_text, self.score_rect = self.make_text("Pontuação",
            (255,255,255), (screen_rect.centerx,100), 50)
        self.pause_text, self.pause_rect = self.make_text("PAUSE",
