...
import random
''' aqui tem alguns elementos do menu como a animação e o proprio menu'''
class Menu(tools.States):
    def __init__(self, screen_rect):
        ...
        self.title, self.title_rect = self.make_text('Doença', (75,75,75), (self.screen_rect.centerx, 75), 150)
